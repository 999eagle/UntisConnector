...
namespace UntisLibrary
{
	public sealed class API
	{
		...
		public Task<(TimetableData timetableData, TimetableFormat timetableFormat)> GetTimetable2017(Class cls, DateTime startDate, uint numOfDays) => GetTimetable2017(cls.ID, ElementType.CLASS, startDate, numOfDays);
		public Task<(TimetableData timetableData, TimetableFormat timetableFormat)> GetTimetable2017(Room room, DateTime startDate, uint numOfDays) => GetTimetable2017(room.ID, ElementType.ROOM, startDate, numOfDays);
		...
		public Task<(TimetableData timetableData, TimetableFormat timetableFormat)> GetTimetable2017(Subject subject, DateTime startDate, uint numOfDays) => GetTimetable2017(subject.ID, ElementType.SUBJECT, startDate, numOfDays);
		public Task<(TimetableData timetableData, TimetableFormat timetableFormat)> GetTimetable2017(Teacher teacher, DateTime startDate, uint numOfDays) => GetTimetable2017(teacher.ID, ElementType.TEACHER, startDate, numOfDays);
		public Task<(TimetableData timetableData, TimetableFormat timetableFormat)> GetTimetable2017(uint id, ElementType type, DateTime startDate, uint numOfDays) => GetTimetable2017(id, (uint)type, startDate, numOfDays);
